...
ID <- read.csv("~/Box Sync/JAP_VU/McLean Lab/Manuscripts/JASMS_Database_June2018/Progenesis/20180427JAP_IDs.csv",
               header = TRUE, stringsAsFactors = FALSE)
all <- read.csv("~/Box Sync/R_Scripts&Data/20171218JAP_iceberg/R-output/allMASTER.csv",
                header = TRUE, stringsAsFactors = FALSE)
serum <- read.csv("~/Box Sync/JAP_VU/McLean Lab/Manuscripts/JASMS_Database_June2018/Progenesis/20180515JAP_progenesis-DT_out.csv",
                  header = TRUE, stringsAsFactors = FALSE)
classfits <- read.csv("~/Box Sync/JAP_VU/McLean Lab/Manuscripts/JASMS_Database_June2018/ClassFits.csv",
                      header = TRUE, stringsAsFactors = FALSE)
...
sl.full <- read.csv("~/Box Sync/JAP_VU/McLean Lab/Manuscripts/JASMS_Database_June2018/serum_lipids.csv", header = TRUE, stringsAsFactors = FALSE)

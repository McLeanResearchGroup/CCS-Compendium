...
#CCS-RSDhist
```{r}
rsd.p <- as.data.frame(cbind(all$Compound, all$mz, all$CCS, all$CCS.z, all$RSD))
...
ccsrsd.p.his <- plot_ly(x = ~rsd.p$RSD, y = ~rsd.p$CCSround, histfunc = "avg", type = "histogram",
  ...
  layout(xaxis = list(title = "<b>% RSD</b>", titlefont = list(size = 22, color = "#000000"),
                      zeroline = FALSE, showline = FALSE, tick0 = 0, dtick = 0.1, showgrid = FALSE, tickfont = list(size = 14, color = "#000000")),
         yaxis = list(title = "<b>CCS/z</b>", titlefont = list(size = 22, color = "#000000"),
                      zeroline = FALSE, showline = FALSE, showgrid = FALSE, tickfont = list(size = 14, color = "#000000")))
ccsrsd.p.his
...
mz.his <- plot_ly(x = ~rsd.p$mzround, type = "histogram", histfunc = "count", color = I("#AFAFAF"), marker = list(line = list(width = 3, color = "#000000"))) %>%
...
ohc.p <- plot_ly(ohc, x= ~ohc$mz, x0 = 0, y= ~ohc$CCS.z, y0 = 0,
  ...
  add_trace(diaz, x = ~diaz$X.curve , y = ~diaz$Y.curve,
            name = "Diazines", type = 'scatter', mode = 'lines',
            line = list(color = "#BAA2F0", width = 3),
            legendgroup = "d", showlegend = TRUE) %>%
  add_trace(diaz, x = ~diaz$X.curve, y = ~(diaz$PI.hi),
            name = "Upper 99% PI - d", type = 'scatter', mode = 'lines',
            fill = "tonexty", fillcolor = "rgba(186, 162, 240, 0.25)",
            line = list(color = "#BAA2F0", width = 3, dash = 'dash'),
            legendgroup = "d", showlegend = FALSE) %>%
  add_trace(diaz, x = ~diaz$X.curve, y = ~(diaz$PI.lo),
            name = "Lower 99% PI - d", type = 'scatter', mode = 'lines',
            fill = "tonexty", fillcolor = "rgba(186, 162, 240, 0.25)",
            line = list(color = "#BAA2F0", width = 3, dash = 'dash'),
            legendgroup = "d", showlegend = FALSE) %>%
  add_trace(diaz, x = ~diaz$X.curve, y = ~(diaz$CI.hi),
            name = "Upper 99% CI - d", type = 'scatter', mode = 'lines',
            line = list(color = "#BAA2F0", width = 3, dash = 'solid'),
            legendgroup = "d", showlegend = FALSE) %>%
  add_trace(diaz, x = ~diaz$X.curve, y = ~(diaz$CI.lo),
            name = "Lower 99% CI - d", type = 'scatter', mode = 'lines',
            line = list(color = "#BAA2F0", width = 3, dash = 'solid'),
            legendgroup = "d", showlegend = FALSE) %>%
  add_trace(diaz, x= ~diaz$m.z, y= ~diaz$CCS.z,
            type = "scatter", mode = "markers", showlegend = TRUE,
            marker = list(size = 18, symbol = "circle", color = "rgba(0, 0, 0, 0.8)"),
            legendgroup = "d", showlegend = FALSE) %>%
  ...
  add_trace(ohc, x= ~ohc$mz, x0 = 0, y= ~ohc$CCS.z, y0 = 0,
            ...
            marker = list(size = 18, symbol = "circle", color = "rgba(50, 50, 50, 0.85)")) %>%

...
ID <- read.csv("~/Box Sync/JAP_VU/McLean Lab/Manuscripts/201808_Databae_ChemSci/Progenesis/20180427JAP_IDs.csv",
               header = TRUE, stringsAsFactors = FALSE)
all <- read.csv("~/Box Sync/R_Scripts&Data/20171218JAP_iceberg/R-output/allMASTER.csv",
                header = TRUE, stringsAsFactors = FALSE)
serum <- read.csv("~/Box Sync/JAP_VU/McLean Lab/Manuscripts/201808_Databae_ChemSci/Progenesis/20180515JAP_progenesis-DT_out.csv",
                  header = TRUE, stringsAsFactors = FALSE)

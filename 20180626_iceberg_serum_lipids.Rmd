...
ID <- read.csv("~/Box Sync/JAP_VU/McLean Lab/Manuscripts/201808_Databae_ChemSci/Data/Progenesis/20180427JAP_IDs.csv",
               header = TRUE, stringsAsFactors = FALSE)
all <- read.csv("~/Box Sync/R_Scripts&Data/20171218JAP_iceberg/R-output/allMASTER.csv",
                header = TRUE, stringsAsFactors = FALSE)
serum <- read.csv("~/Box Sync/JAP_VU/McLean Lab/Manuscripts/201808_Databae_ChemSci/Data/Progenesis/20180515JAP_progenesis-DT_out.csv",
                  header = TRUE, stringsAsFactors = FALSE)
...
res1 <- read.delim("~/Box Sync/JAP_VU/McLean Lab/Manuscripts/201808_Databae_ChemSci/Progenesis/20180425JAP_IMS_pos_rep1_12.txt")
...
a.s.l <- plot_ly(all, x= ~all$mz, x0 = 0, y= ~all$CCS.z, y0 = 0,
                type = "scatter", mode = "markers", showlegend = TRUE,
                marker = list(size = 1, color = "rgba(50, 50, 50, 0.1)")) %>%
  add_trace(all, x= ~all$mz, x0 = 0, y= ~all$CCS.z, y0 = 0,
            name = "all", type = "scatter", mode = "markers", showlegend = TRUE,
            marker = list(size = 15, color = "rgba(50, 50, 50, 0.6)", symbol = "circle")) %>%
  add_trace(serum, x= ~serum$mz.p, x0 = 0, y= ~serum$ccsz, y0 = 0,
            name = "serum", type = "scatter", mode = "markers", showlegend = TRUE,
            marker = list(size = 15, color = "rgba(251, 186, 13, 0.6)", symbol = "circle")) %>%
  # add_trace(tmp, x= ~tmp$mz.p, x0 = 0, y= ~tmp$ccsz, y0 = 0,
  #           type = "scatter", mode = "markers", showlegend = FALSE,
  #           marker = list(size = 15, symbol = "x-thin-open", color = "#1430FA")) %>%
  layout(xaxis = list(zeroline = FALSE, showline = TRUE, linewidth = 10,
                      ticks = "outside", ticklen = 10, tickwidth = 10, dtick = 500,
                      tickfont = list(family = "Arial", size = 26, color = "#000000"),
                      showgrid = FALSE),
         yaxis = list(zeroline = FALSE, showline = TRUE, linewidth = 10,
